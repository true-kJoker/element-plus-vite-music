...
// 登录
const login = ({ phone = '',  captcha = "" }) => { return api.get(`/login/cellphone?phone=${phone}&captcha=${captcha}`, {}) }
// 二维码登录
...
// 手机验证码登录
const loginSent = ({ phone = "" }) => { return api.get(`/captcha/sent?phone=${phone}`, {}) }
const loginVerify = ({ phone = "", captcha = "" }) => { return api.get(`/captcha/verify?phone=${phone}&captcha=${captcha}`, {}) }
// 退出登录
